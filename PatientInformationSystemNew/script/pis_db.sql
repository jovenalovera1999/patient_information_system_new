...
CREATE TABLE pis_db.users (
    ...
    user_id                             VARBINARY(855) NOT NULL,
    profile_picture                     BLOB DEFAULT NULL,
    username                            VARBINARY(855) NOT NULL,
    password                            VARBINARY(855) NOT NULL,
    first_name                          VARBINARY(855) NOT NULL,
    middle_name                         VARBINARY(855) DEFAULT NULL,
    last_name                           VARBINARY(855) NOT NULL,
    gender                              VARBINARY(855) NOT NULL,
    age                                 VARBINARY(855) NOT NULL,
    address                             VARBINARY(855) NOT NULL,
    birthday                            DATE,
    cellphone_number                    VARBINARY(855) DEFAULT NULL,
    telephone_number                    VARBINARY(855) DEFAULT NULL,
    email                               VARBINARY(855) DEFAULT NULL,
    role                  				VARBINARY(855) NOT NULL,
    specialization                      VARBINARY(855) DEFAULT NULL,
...
CREATE TABLE pis_db.schedule (
    ...
    patient_id                          VARBINARY(855) NOT NULL,
    first_name                          VARBINARY(855) NOT NULL,    
    middle_name                         VARBINARY(855) DEFAULT NULL,
    last_name                           VARBINARY(855) NOT NULL,
    gender                              VARBINARY(855) NOT NULL,
    birthday                            DATE,
    status                              VARBINARY(855) DEFAULT AES_ENCRYPT('Waiting', 'j0v3ncut3gw4p0per0jok3l4ang'),
    date                                TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                        PRIMARY KEY(id),
...
CREATE TABLE pis_db.patients (
    ...
    telephone_number                    VARBINARY(855) DEFAULT NULL,
    email                               VARBINARY(855) DEFAULT NULL,
    status                              VARBINARY(855) DEFAULT AES_ENCRYPT('In Consultation', 'j0v3ncut3gw4p0per0jok3l4ang'),
    payment_status                      VARBINARY(855) DEFAULT AES_ENCRYPT('Unpaid', 'j0v3ncut3gw4p0per0jok3l4ang'),
    date                                TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                        PRIMARY KEY(id),
                                        FOREIGN KEY(doctor_fid) REFERENCES pis_db.users(id)
);
...
CREATE TABLE pis_db.number_of_patients (
    id                                  INT NOT NULL AUTO_INCREMENT,
    doctor_fid                          INT NOT NULL,
    full_name                           VARBINARY(855) NOT NULL,
    date                                TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                        PRIMARY KEY(id),
                                        FOREIGN KEY(doctor_fid) REFERENCES pis_db.users(id)
);
...
CREATE TABLE pis_db.vital_signs (
    ...
    height                              VARBINARY(855) DEFAULT NULL,
    weight                              VARBINARY(855) NOT NULL,
    temperature                         VARBINARY(855) NOT NULL,
    pulse_rate                          VARBINARY(855) DEFAULT NULL,
    blood_pressure                      VARBINARY(855) DEFAULT NULL,
    status                              VARBINARY(855) DEFAULT AES_ENCRYPT('Visible', 'j0v3ncut3gw4p0per0jok3l4ang'),
    date                                TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                        PRIMARY KEY(id),
...
CREATE TABLE pis_db.diagnosis (
    id                                  INT NOT NULL AUTO_INCREMENT,
    patient_fid                         INT NOT NULL,
    diagnosis                           VARBINARY(855) DEFAULT NULL,
    status                              VARBINARY(855) DEFAULT AES_ENCRYPT('Visible', 'j0v3ncut3gw4p0per0jok3l4ang'),
    date                                TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                        PRIMARY KEY(id),
                                        FOREIGN KEY(patient_fid) REFERENCES pis_db.patients(id)
...
CREATE TABLE pis_db.symptoms (
    id                                  INT NOT NULL AUTO_INCREMENT,
    patient_fid                         INT NOT NULL,
    symptoms                            VARBINARY(855) DEFAULT NULL,
    status                              VARBINARY(855) DEFAULT AES_ENCRYPT('Visible', 'j0v3ncut3gw4p0per0jok3l4ang'),
    date                                TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                        PRIMARY KEY(id),
                                        FOREIGN KEY(patient_fid) REFERENCES pis_db.patients(id)
...
CREATE TABLE pis_db.prescriptions (
    id                                  INT NOT NULL AUTO_INCREMENT,    
    patient_fid                         INT NOT NULL,
    prescriptions                       VARBINARY(855) DEFAULT NULL,
    status                              VARBINARY(855) DEFAULT AES_ENCRYPT('Visible', 'j0v3ncut3gw4p0per0jok3l4ang'),
    date                                TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                        PRIMARY KEY(id),
                                        FOREIGN KEY(patient_fid) REFERENCES pis_db.patients(id)
...
CREATE TABLE pis_db.payment_transactions (
    ...
    discount                            VARBINARY(855) DEFAULT NULL,
    amount                              VARBINARY(855) NOT NULL,
    total_amount_paid                   VARBINARY(855) NOT NULL,
...
CREATE TABLE pis_db.cashier (
    ...
    cashier                             VARBINARY(855) NOT NULL,
    date                                TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                        PRIMARY KEY(id),
...
CREATE TABLE pis_db.inventory (
    id                                  INT NOT NULL AUTO_INCREMENT,
    supplier                            VARBINARY(855) NOT NULL,
    supply_id                           VARBINARY(855) NOT NULL,
    supply_name                         VARBINARY(855) NOT NULL,
    quantity                            VARBINARY(855) NOT NULL,
...
CREATE TABLE pis_db.update_history_patient (
    id                                  INT NOT NULL AUTO_INCREMENT,
    user                                VARBINARY(855) NOT NULL,
    patient                             VARBINARY(855) NOT NULL,
    description                         VARBINARY(855) NOT NULL,
    date                                TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                        PRIMARY KEY(id)
);
...
CREATE TABLE pis_db.update_history_inventory (
    id                                  INT NOT NULL AUTO_INCREMENT,
    user                                VARBINARY(855) NOT NULL,
    issued_to                           VARBINARY(855) NOT NULL,
    description                         VARBINARY(855) NOT NULL,
    date                                TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                        PRIMARY KEY(id)
);
