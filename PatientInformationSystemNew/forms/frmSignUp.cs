...
namespace PatientInformationSystemNew.forms
{
    public partial class frmSignUp : Form
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            {
                if(this.cmbRole.Text == "Doctor" && String.IsNullOrWhiteSpace(this.txtSpecialization.Text))
                {
                ...
                else
                {
                    if (String.IsNullOrWhiteSpace(imgLocation))
                    {
                        ...
                        else if (String.IsNullOrWhiteSpace(this.cmbRole.Text))
                        {
                            ...
                            this.dateBirthday.Value.Date, this.txtCellphoneNumber.Text, this.txtTelephoneNumber.Text, this.txtEmail.Text, this.cmbRole.Text,
                    ...
                    else
                    {
                        ...
                        else if (String.IsNullOrWhiteSpace(this.cmbRole.Text))
                        {
                            ...
                            this.txtAddress.Text, this.dateBirthday.Value.Date, this.txtCellphoneNumber.Text, this.txtTelephoneNumber.Text,
